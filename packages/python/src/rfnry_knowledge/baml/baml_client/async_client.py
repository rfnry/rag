...
class BamlAsyncClient:
    ...
    async def AnalyzeStructuredPage(self, page_image: baml_py.Image,
        baml_options: BamlCallOptions = {},
    ) -> types.PageAnalysis:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="AnalyzeStructuredPage", args={
    ...
    async def ExtractEntitiesFromText(self, text: str,
        ...
        if 'on_tick' in baml_options:
            ...
            return typing.cast(types.PageAnalysis, __result__.cast_to(types, types, stream_types, False, __runtime__))
    async def ExtractMemories(self, interaction: str,occurred_at: str,existing_memories: str,
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="ExtractMemories", args={
    ...
    async def GenerateText(self, system: str,history: str,user: str,
        baml_options: BamlCallOptions = {},
    ) -> str:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="GenerateText", args={
    ...
    async def SituateChunk(self, document: str,chunk: str,max_tokens: int,
        baml_options: BamlCallOptions = {},
    ) -> str:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="SituateChunk", args={
...
class BamlStreamClient:
    ...
    def AnalyzeStructuredPage(self, page_image: baml_py.Image,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="AnalyzeStructuredPage", args={
            "page_image": page_image,
        })
    ...
    def ExtractMemories(self, interaction: str,occurred_at: str,existing_memories: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.ExtractedMemoryList, types.ExtractedMemoryList]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="ExtractMemories", args={
            "interaction": interaction,"occurred_at": occurred_at,"existing_memories": existing_memories,
        })
        return baml_py.BamlStream[stream_types.ExtractedMemoryList, types.ExtractedMemoryList](
          __result__,
    ...
    def GenerateText(self, system: str,history: str,user: str,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="GenerateText", args={
            "system": system,"history": history,"user": user,
        })
    ...
    def SituateChunk(self, document: str,chunk: str,max_tokens: int,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="SituateChunk", args={
            "document": document,"chunk": chunk,"max_tokens": max_tokens,
        })
        return baml_py.BamlStream[str, str](
          __result__,
...
class BamlHttpRequestClient:
    ...
    async def AnalyzeStructuredPage(self, page_image: baml_py.Image,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="AnalyzeStructuredPage", args={
            "page_image": page_image,
        }, mode="request")
        return __result__
    async def CheckRelevance(self, query: str,passage: str,
    ...
    async def ExtractMemories(self, interaction: str,occurred_at: str,existing_memories: str,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ExtractMemories", args={
            "interaction": interaction,"occurred_at": occurred_at,"existing_memories": existing_memories,
        }, mode="request")
        return __result__
    async def GenerateSyntheticQueries(self, passage: str,num_queries: int,
    ...
    async def GenerateText(self, system: str,history: str,user: str,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="GenerateText", args={
            "system": system,"history": history,"user": user,
        }, mode="request")
        return __result__
    async def JudgeAnswerQuality(self, query: str,prediction: str,reference: str,
    ...
    async def SituateChunk(self, document: str,chunk: str,max_tokens: int,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="SituateChunk", args={
            "document": document,"chunk": chunk,"max_tokens": max_tokens,
        }, mode="request")
        return __result__
    async def SynthesizeDocument(self, page_analyses: str,
