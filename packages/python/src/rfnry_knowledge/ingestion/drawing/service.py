...
from rfnry_knowledge.ingestion.drawing.extract_dxf import extract_dxf_analysis
from rfnry_knowledge.ingestion.drawing.linker import pair_off_page_connectors
from rfnry_knowledge.ingestion.drawing.models import (
    DetectedComponent,
    DetectedConnection,
    DrawingPageAnalysis,
)
from rfnry_knowledge.ingestion.drawing.render import render_dxf, render_pdf_pages
...
from rfnry_knowledge.stores.graph.drawing_mapper import drawing_to_graph
...
class DrawingIngestionService:
    ...
    async def extract(self, source_id: str) -> Source:
        ...
        from rfnry_knowledge.ingestion.drawing.extract_pdf import (
