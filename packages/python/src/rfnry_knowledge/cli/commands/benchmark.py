...
async def _benchmark(
    ...
    from rfnry_knowledge.observability.benchmark import BenchmarkCase, BenchmarkConfig
    ...
    try:
        ...
        async with KnowledgeEngine(server_config) as engine:
            report = await engine.benchmark(cases, config=bench_config, knowledge_id=knowledge_id)
