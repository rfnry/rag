...
from rfnry_rag.cli.output import OutputMode, print_error, print_json, print_query_result
...
async def _query(server_config, text, knowledge_id, min_score, session_name, mode):
    from rfnry_rag.cli.commands.session import load_session, save_turn
