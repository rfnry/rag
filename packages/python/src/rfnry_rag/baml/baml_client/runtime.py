...
class BamlCallOptions(typing.TypedDict, total=False):
    ...
    collector: typing_extensions.NotRequired[baml_py.baml_py.Collector | list[baml_py.baml_py.Collector]]
...
class DoNotUseDirectlyCallManager:
    ...
    def call_function_sync(self, *, function_name: str, args: dict[str, typing.Any]) -> baml_py.baml_py.FunctionResult:
        resolved_options = self.__resolve()
    ...
    def parse_response(
        self, *, function_name: str, llm_response: str, mode: typing_extensions.Literal["stream", "request"]
    ) -> typing.Any:
        resolved_options = self.__resolve()
