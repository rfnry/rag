...
class LlmResponseParser:
    ...
    def SummarizeCluster(
        ...
        __result__ = self.__options.merge_options(baml_options).parse_response(function_name="SummarizeCluster", llm_response=llm_response, mode="request")
...
class LlmStreamParser:
    ...
    def SummarizeCluster(
        ...
        __result__ = self.__options.merge_options(baml_options).parse_response(function_name="SummarizeCluster", llm_response=llm_response, mode="stream")
