...
_RRAG_BAML_LOG_ENV = "RRAG_BAML_LOG"


def _propagate_baml_log_env() -> None:
    """Wire RRAG_BAML_LOG to BAML_LOG (what BAML actually reads) so users have
    ...
    """
    user_value = os.getenv(_RRAG_BAML_LOG_ENV)
...
def get_logger(module: str) -> logging.Logger:
    ...
    if os.getenv("RRAG_LOG_ENABLED", "false").lower() == "true":
        level = os.getenv("RRAG_LOG_LEVEL", "INFO").upper()
